							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Lime Tree Bay, Moskito Island</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">USD $22,500,000.00</span>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
													<fieldset>
														...
														<input type="hidden" name="item_name" value="Lime Tree Bay, Moskito Island" />
														<input type="hidden" name="amount" value="22500000.00" />
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Darby Island</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">$43,000,000.00</span>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
													<fieldset>
														...
														<input type="hidden" name="add" value="1" />
														<input type="hidden" name="business" value=" " />
														<input type="hidden" name="item_name" value="Darby Island" />
														<input type="hidden" name="amount" value="43000000.00" />
														<input type="hidden" name="currency_code" value="USD" />
														<input type="hidden" name="return" value=" " />
														<input type="hidden" name="cancel_return" value=" " />
														<input type="submit" name="submit" value="Add to cart" class="button btn" />
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								24 Long Street, Cape Town.</li>
							<li class="mb-3">
								082 953 8130 </li>
							<li class="mb-3">
								021 554 1789 </li>
							<li class="mb-3">
								industry@island.com </a>
							</li>
							<li>
								island@industry.com </a>
							</li>
						</ul>
					</div>
